...
$this->Ln(0);
$from = $_POST['date1'];
$nama = $_POST['_fldsnamabrg'];
$this->SetFont('Arial', 'B', 11);
$this->Cell(0 ,0.75,"LAPORAN Penjualan Periode ".format_indo($from)." BARANG ".$nama."",0,1,'C');
$this->Ln(0);
...
$nama = $_POST['_fldsnamabrg'];
include 'koneksi.php';
$query = mysqli_query($koneksi, "SELECT * FROM tbl_pembelian  WHERE (_flddtgl = '$from' ) AND _fldsnamabrg ='$nama' ORDER BY _flddtgl ASC");
...
$q = mysqli_query($koneksi, "SELECT SUM(_fldstotal) AS tot FROM tbl_pembelian WHERE (_flddtgl = '$from') AND _fldsnamabrg ='$nama' ");
